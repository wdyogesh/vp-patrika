    ...
    <div class="container">
        ...
        <!--php code here -->
            ...
            <div class="col-lg-3 list-group">
                ...
                <a style="background-color: #ffbf09b8;" href="message-sent.php" class="list-group-item">
            ...
            <div class="col-lg-8 col-md-7 list-group">
                <span href="#" class="list-group-item active message-box">New Messages</span>
                      <div class="list-group-item" id="list-group-item" style="height: 400px;overflow: auto;">
                        <?php $messages_users = user::find_message_list_sent($my_profile_details->user_id);
                                ...
                                <div class="chat_list active_chat">
                                    <div class="chat_people">
                                        ...
                                        <div class="chat_ib">
                                            <h5><a href="view_profile.php?profile_id=<?= $profile_decode?>"><?=$messages_user->name?>, <?=$messages_user->user_id?></a>
