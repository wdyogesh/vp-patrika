...
?>
  ...
  <head>
    <title>Vishwakarma Patrika Admin  | Active Users </title>
        ...
        <div class="span9" id="content">
          <div class="row-fluid">
            <?php
              ...
              $query_count = $cid->query("SELECT * FROM user_details WHERE id_conform = '1'");
              $count_sign_up = $query_count->num_rows;
            ?>
            <div class="block">
              <div class="navbar navbar-inner block-header">
                <div class="muted pull-left">
                  <span class="label label-info"> Active Users (<?= $count_sign_up ?>)</span>
                </div>
              </div>
