      ...
      if ($count == 1) {
        ...
        if ($user_name_db == $user_name) {
          if ($password_db == $password) {
            ...
            $responseMessage =  "<span style='color:red;' >* Enter Your correct Password !! </span>";
          }
        } else {
          $responseMessage =  "<span style= 'color:red'>* Please Enter Corret User Name !! </span>";
        }
      } else {
        $responseMessage = "<span style= 'color:red'>* This is only for Admin !! </span>";
      }
    }
    ?>
    <form class="form-signin" method="post" action="login.php" autocomplete="off">
      <h4 class="form-signin-heading">Vishwakarma Patrika | Admin</h4>
      <?php 
