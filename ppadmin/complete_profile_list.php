            ...
            <div class="row-fluid">
               <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active" >
                            <a href="complete_profile_list.php"><i class="icon-chevron-right"></i> Send Intrested </a>
                        </li>
                        <li>
                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
                        ...
                        $sql_query= $cid->query("SELECT * FROM `user_interest` ORDER BY `user_interest`.`id` ASC");
