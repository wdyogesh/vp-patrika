...
<html>
    ...
    <head>
        <title>Vishwakarma Patrika Admin Panel</title>
        <!-- Bootstrap -->
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <span class="label label-important"> 
                                	<a href="sign_up.php" style="text-decoration: none; color: #fff;"> 
                                    << GO Back </a> 
                                 </span> Details Of  Prfile Id:  <span class="label label-success"> <?php echo $user_id;  ?>  </span>
                                 ...
                                 <!-- paymenet Approval -->
                                  <?php if ($payment != '1'): ?>
                                    <span class="label label-success">
								        <a href="activation.php?code=payment&user_id=<?php echo $user_id; ?>" style="text-decoration: none; color: #fff;">Payment Disapproval</a>
								    </span>
                                  <?php endif;?>
                                  </div>
                            </div>
